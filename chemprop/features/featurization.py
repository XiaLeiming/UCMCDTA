...
class MolGraph:
    ...
    def __init__(self, smiles: str, args: Namespace):
        ...
        self.f_atoms = [self.f_atoms[i] for i in range(self.n_atoms)]       # 每个原子是一个133的编码，一个分子有多少个原子，就有 数量 乘 133维度 的数据
        ...
        for a1 in range(self.n_atoms):
            for a2 in range(a1 + 1, self.n_atoms):
                ...
                # Update index mappings  ,更新索引映射,以下都是在存在以上边的情况下，
                b1 = self.n_bonds
                b2 = b1 + 1
...
class BatchMolGraph:
    ...
    - atom_fdim: The dimensionality of the atom features.   原子的维数特征。
    ...
    def __init__(self, mol_graphs: List[MolGraph], args: Namespace):
        ...
        self.bond_fdim = get_bond_fdim(args) + (not args.atom_messages) * self.atom_fdim # * 2          # 147
        ...
        self.a2a = self.get_a2a()  # only needed if using atom messages
        self.b2b = self.get_b2b()
    ...
    def get_components(self) -> Tuple[torch.FloatTensor, torch.FloatTensor,
        ...
        return self.f_atoms, self.f_bonds, self.a2b, self.b2a, self.b2revb, self.a_scope, self.b_scope, self.bonds, self.a2a, self.b2b
